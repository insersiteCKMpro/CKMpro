        ...
        <div class="ensemblefooter">
            <div class="footerhaut text-center">
                <div class="colonne1 text-center">
                    ...
                    <a class="ftext1" href="espacevert.php">Connexion</a>
                    <a class="ftext1" href="espacevert.php">Panier</a>
                    <a class="ftext1" href="espacevert.php">Recherche</a>
                </div>

                <div class="colonne2 text-center">
                    <a class="ftext2" href="">La Vitrine</a><br>
