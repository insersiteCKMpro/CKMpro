...
<head>
    ...
    <style>
    <?php
    require_once ("CSS/headerstyle.css");
    ?>
    </style>
...
<body>
    ...
    <header>
        <div class="fixed-top">
            ...
            <div class="logo">
                <img src="img/LOGOCKMPRODEF.png" alt="logo" id="logoTitre">
            </div>
        </div>
    </header>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample03">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item li1" id="tailleLi">
                    <a class="nav-link" id="tailleA" href="#"><img src="img/CKMHOMEFOOTER.png" alt="Logo Home" id="logoHome"></a>
                </li>


                <li class="nav-item dropdown li2">
                    <a class="nav-link dropdown-toggle navMarg colorJ" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">3D</a>
                ...
                <li class="nav-item dropdown li5">
                    <a class="nav-link dropdown-toggle navMarg" href="#" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Galeries</a>
