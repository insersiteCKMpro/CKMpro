...
<body>
  <div class="container-fluid">
    <header>
      ...
      <div class="logo">
        <a href="homepage.php"><img src="include/img/LOGOCKMPRODEF.png" alt="logo" class="logoTitre"></a>
      </div>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample03">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item li4">
              <a class="nav-link navMarg colorV" href="ecpacevert.php" tabindex="-1" aria-disabled="true">Espaces Verts</a>
            </li>
            <hr class="mx-auto bg-dark text-center">
            <li class="nav-item dropdown li5">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown03">
                ...
                <a class="dropdown-item dropdown-item04" href="galerieecpacevert.php">Espaces Verts</a>
              </div>
            </li>
            <hr class="mx-auto bg-dark text-center">
          </ul>
