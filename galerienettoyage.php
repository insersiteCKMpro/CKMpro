...
<style>
  ...
  @media screen and (max-width: 450px){
    ...
    .demo1{width: 100%; height: 10vh; margin:auto; display: flex;}
    .demo2{width: 90%; height: 10vh; margin:auto; display: flex;}
    .demo3{width: 90%; height: 10vh; margin:auto; display: flex;}
    .demo4{width: 90%; height: 10vh; margin:auto; display: flex;}
