...
<section>
  <div class="container-fluid">
      ...
      class="hover-shadow img3">
      </div>
  
      </div>
      
      <div class="emplacement4 mx-auto text-center mb-5">
      <img src="https://ironcodestudio.com/wp-content/uploads/2015/03/css-remove-horizontal-scrollbar.jpg" onclick="openModal();currentSlide(4)" class="img-fluid hover-shadow img4">
      </div>
...
<!-- _____________________________VISUEL DU ZOOM----------------------------------------------------------------- -->
        <div class="mySlides">
          ...
          <img src="https://ironcodestudio.com/wp-content/uploads/2015/03/css-remove-horizontal-scrollbar.jpg" class="mySlides1">
          </div>
        ...
        <!-- _____________________________VISUEL DES IMAGES EN BAS QUAND ON ZOOM----------------------------------------------------------------- --> 
          ...
          <div class="column">
            <img class="demo2" src="https://laboutiquedemei.fr/img/cms/Photographie/chute%20eau%20vertical%20per1%20450.jpg"  onclick="currentSlide(2)">
          </div>

          <div class="column">
            <img class="demo3" src="https://laboutiquedemei.fr/img/cms/Photographie/chute%20eau%20vertical%20per1%20450.jpg"  onclick="currentSlide(3)">
          </div>

          <div class="column">
            <img class="demo4" src="https://ironcodestudio.com/wp-content/uploads/2015/03/css-remove-horizontal-scrollbar.jpg" onclick="currentSlide(4)">
          </div>
        </div>
      </div>
    </div>
